...
| <a name="input_group_ids"></a> [group\_ids](#input\_group\_ids) | A list of group IDs whose members can approve of the merge request | `set(number)` | `[]` | no |
...
| <a name="input_protected_branch_ids"></a> [protected\_branch\_ids](#input\_protected\_branch\_ids) | A list of protected branch IDs (not branch names) for which the rule applies | `set(number)` | `[]` | no |
...
| <a name="input_user_ids"></a> [user\_ids](#input\_user\_ids) | A list of specific User IDs to add to the list of approvers | `set(number)` | `[]` | no |
